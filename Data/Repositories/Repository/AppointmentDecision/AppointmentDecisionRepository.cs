...
namespace Data.Repositories.Repository.AppointmentDecision
{
    internal class AppointmentDecisionRepository
    {
        private readonly AppDbContext _dbContext;
        private readonly ILogger<AppointmentDecisionRepository> _logger;

        public AppointmentDecisionRepository(AppDbContext dbContext, ILogger<AppointmentDecisionRepository> logger)
        {
