...
{
    public class CreateRequestVMValidator : AbstractValidator<CreateRequestVM>
    {
        public CreateRequestVMValidator(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(x => x.RequestNumber).NotEmpty()
                                         ...
                                         .WithMessage("This Request Number Already Exist!");
