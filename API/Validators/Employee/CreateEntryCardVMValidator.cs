...
{
    public class CreateEntryCardVMValidator : AbstractValidator<CreateEntryCardVM>
    {
        public CreateEntryCardVMValidator(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(x => x.SecurityNumber).NotEmpty()
                                          ...
                                          {
                                              return (!await unitOfWork.EntryCards.AlreadyExistSecurityNumberAsync(value));
                                          })
                                          .WithMessage("This Security Number Already Exist!");
