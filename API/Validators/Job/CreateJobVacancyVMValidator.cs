...
{
    public class CreateJobVacancyVMValidator : AbstractValidator<CreateJobVacancyVM>
    {
        public CreateJobVacancyVMValidator(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(x => x.VacantNumber).NotEmpty()
                                        ...
                                        {
                                            return (!await unitOfWork.JobVacancy.AlreadyExistVacantNumberAsync(value));
                                        })
                                        .WithMessage("This VacantNumber Already Exist!");
